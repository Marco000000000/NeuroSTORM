...
OUTPUT_DIR = "/home/mfinocchiaro/miccai2026/NeuroSTORM/hbn_data/neurostorm_features_split"
...
class HBN_Split_Inference(Dataset):
    def __init__(self, root, task_filter, seq_len=20):
        ...
        for subj in subjects:
            ...
            idx_train_end = int(num_frames * 0.80)
            idx_val_end = int(num_frames * 0.90)
            ...
            for start_idx in range(0, max_start + 1, 1): # Stride = 1
                ...
                # Se inizia prima dell'80%, è train.
                # Se inizia tra 80% e 90%, è val.
                # Altrimenti è test.
